        ...
        <>
            ...
            <main className="bg-[#1c1c1c] flex min-h-screen flex-col align-center items-center w-full text-white">
                ...
                <section className="flex flex-col px-5 lg:px-0 lg:grid lg:grid-cols-12 lg:gap-8 lg:max-w-[75rem]">
                    ...
                    <div className="col-start-5 col-end-13 self-center ml-2">
                ...
                <section className="flex flex-col px-5 lg:px-0 lg:grid lg:grid-cols-3 lg:gap-8 pt-24 lg:max-w-[75rem]">
                    <div>
                ...
                <section className="pt-40 px-5 lg:px-0 lg:max-w-[75rem] w-full">
                    <h2 className="text-4xl font-bold w-full">Notre Stack</h2>
                    <div className="flex flex-col sm:grid sm:grid-cols-2 gap-24 pt-16 ">
                        <div className="">
                ...
                <section className="px-5 lg:px-0 lg:grid lg:grid-cols-2 lg:gap-10 pt-56 lg:max-w-[75rem]">
                    <div>
                    ...
                    <div className="pt-56">
                        <h2 className="text-white text-2xl pt-36 pb-10 courrier font-bold">Harder, better, faster, coder.</h2>
                        ...
                        <Link className="flex justify-end" href="/life"><button className="bg-[#db3753] w-[13rem] h-[3.8rem] rounded-[15px] text-white mt-5 hover:bg-[#fcfcfc] border-red-600 border-2 border-solid hover:text-[#db3753] transition duration-300">La Picta quoi ?</button></Link>
                    </div>
                </section>
                <section className="pt-56 pb-12 px-5 lg:px-0 w-screen lg:max-w-[75rem]">
                    <h2 className="text-4xl font-bold pb-10">En attendant, rencontre l’équipe !</h2>
                    <div className="flex justify-center mt-8">

                        <Carousel
                            className="rounded-xl w-screen lg:w-[800px] items-center"
                ...
                <section className="px-5 lg:px-0 lg:max-w-[75rem]">
                    ...
                    <div className="grid grid-cols-4 gap-5">
                        ...
                        <div className="bg-[#2b2b2b] p-5 h-fit lg:h-[19rem] rounded-[5px]">
                            <div className="flex flex-row">
                                <Image src="https://a.storyblok.com/f/189744/320x324/be5bffd1df/div-5.png" alt="key" width={80} height={80}/>
                                <h2 className="text-xl font-bold self-center ml-5">Admin</h2>
                            </div>
                            <p className="text-base leading-5 pt-5">Tous les outils de l’admin nous ont permis de créer une machine de guerre marketing pour cibler les meilleurs utilisateurs possibles !</p>
                        </div>
                    
                        <div className="bg-[#2b2b2b] p-5 h-fit lg:h-[19rem] rounded-[5px]">
                            <div className="flex flex-row">
                                <Image src="https://a.storyblok.com/f/189744/320x324/f4ce2d8063/div-3.png" alt="key" width={80} height={80} />
                                <h2 className="text-xl font-bold self-center ml-5">App Ninja</h2>
                            </div>
                            <p className="text-base leading-5 pt-5">Grâce à App Ninja, l’équipe de Pictarine peut lire et répondre à chaque avis sur nos applications Android et iOS sans se connecter à l’App Store Connect ou à la Google Play Console depuis l’application Slack.</p>
                        </div>
                        <div className="bg-[#2b2b2b] p-5 h-fit lg:h-[19rem] rounded-[5px]">
                            <div className="flex flex-row">
                                <Image src="https://a.storyblok.com/f/189744/320x324/60fd86abfa/div-4.png" alt="key" width={80} height={80} />
                                <h2 className="text-xl font-bold self-center ml-5">Snip</h2>
                            </div>
                            <p className="text-base leading-5 pt-5">Snip est une application de gestion d’extraits de code légère pour macOS. Entièrement écrit en SwiftUI, Snip prend en charge plus de 100 langages de programmation, la synchronisation GitHub gist et l’aperçu HTML / Markdown.</p>
                        </div>
                    
                        <div className="bg-[#2b2b2b] p-5 h-fit lg:h-[19rem] rounded-[5px]">
                            <div className="flex flex-row">
                                <Image src="https://a.storyblok.com/f/189744/320x324/1db751194d/image.png" alt="key" width={80} height={80} />
                                <h2 className="text-xl font-bold self-center ml-5">Trognon</h2>
                            </div>
                            <p className="text-base leading-5 pt-5">L’app Slack Trognon permet en temps réel d’avoir un update Slack du statut d’une app. Elle est basée sur l’API App Store Connect.</p>
                        </div>

                        <div className="bg-[#2b2b2b] p-5 h-fit lg:h-[19rem] rounded-[5px]">
                            <div className="flex flex-row">
                                <Image src="https://a.storyblok.com/f/189744/320x324/3b99df5b3b/div.png" alt="key" width={80} height={80} />
                                <h2 className="text-xl font-bold self-center ml-5">BigQuery</h2>
                            </div>
                            <p className="text-base leading-5 pt-5">Notre extension BigQuery permet d’afficher le coût d’une query avant de la lancer. Ce projet est public et open source.</p>
                        </div>

                        <div className="bg-[#2b2b2b] p-5 h-fit lg:h-[19rem] rounded-[5px]">
                            <div className="flex flex-row">
                                <Image src="https://a.storyblok.com/f/189744/320x324/beea1e23d6/div-2.png" alt="key" width={80} height={80} />
                                <h2 className="text-xl font-bold self-center ml-5">Release Note Now</h2>
                            </div>
                            <p className="text-base leading-5 pt-5">Automatic Release Note Generator for GitHub projects. Cet outil a été extrait pour être publié comme un projet Open Source sur Github.</p>
                        </div>

                        <div className="bg-[#2b2b2b] p-5 h-fit lg:h-[19rem] col-start-1 rounded-[5px]">
                            <div className="flex flex-row">
                                <Image src="https://a.storyblok.com/f/189744/320x324/44b2092250/div-1.png" alt="key" width={80} height={80} />
                                <h2 className="text-xl font-bold self-center ml-5">Today’s Widget</h2>
                            </div>
                            <p className="text-base leading-5 pt-5">Today’s Widget est un widget météo simple et rapide pour l’écran d’accueil de l’iPhone. Il fonctionne sur tous les appareils iOS/iPadOS fonctionnant actuellement sous iOS 14+.</p>
                        </div>
                        ...
                        <div className="pt-12 col-start-3 col-end-5">
                            <p className="text-white text-[1.7rem] w-full text-end pt-8 pl-28"> <span className="inline-block mr-1"><Hello /></span>Découvre en détail notre App et nos explos Produits</p>
                            <Link className="flex justify-end" href="/life"><button className="bg-[#db3753] w-32 h-[3.8rem] rounded-[10px] text-white mt-5 hover:bg-[#fcfcfc] border-red-600 border-2 border-solid hover:text-[#db3753] transition duration-300">Nos Produits</button></Link>
                        </div>
                    </div>
                </section>
                <section className="lg:max-w-[75rem] pt-20">
                    <h2 className="flex flex-col text-center w-full text-[3.5rem] leading-[3.5rem]">Ça donne envie?
                        <span className="text-[4.35rem] font-bold text-center text-[#db3753] italic ml-5">Rejoins-nous!</span>
                    </h2>

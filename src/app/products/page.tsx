    ...
    return(
        <>
            ...
            <main className="flex flex-col w-full items-center overflow-hidden">
                <section className="lg:pt-[6.5rem] flex flex-col px-5 lg:px-0  lg:grid lg:grid-cols-12 lg:gap-7 lg:max-w-[75rem] w-full">
                    <div className="col-start-1 col-end-7 pt-10 lg:pt-28">
                        <h2 className="text-[1.5rem] lg:text-[3.5rem] flex flex-col">
                            Notre produit phare
                            <span className="absolute pt-5 lg:pt-12 pl-6 text-red-600 text-[2.2rem] lg:text-[4.2rem] italic font-extrabold ">the Picta App</span>
                        </h2>
                        <p className="leading-5 pt-12 lg:pt-20">Notre main product ? Une application qui permet de modifier et d'imprimer des photos en 3 clics, partout aux Etats-Unis. Ensuite, il suffit d'aller les récupérer en magasin en moins d’une heure. It’s that easy!</p>
                        <div className="flex flex-row">
                            <Image className="pt-5" src={verti_bar} alt="verti-bar" />
                            <div className="pl-5 pt-5">
                                <h2 className="font-bold italic text-sm">Best printing app!</h2>
                                <p className="pt-2 italic text-sm w-full lg:w-96">Super quick, no hassle. No sign in required. I’ve use this app for a few years now and it’s always been great.</p>
                                <p className="pt-2 text-sm">Stephen J.</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex justify-center pt-5 lg:pt-0 lg:col-start-7 lg:col-end-12">
                        <Image className="lg:pl-8 flex w-full align-center lg:w-full" src={gif_iphone} alt="gif-iphone" />
                    </div>
                </section>
                <section className="pt-24 lg:pt-[11rem] flex flex-col px-5 lg:px-0 lg:grid lg:grid-cols-4 gap-9 lg:max-w-[75rem]">
                    <div>
                ...
                <section className="flex flex-col px-5 lg:px-0 pt-16 w-full pb-16 max-w-[75rem]">
                    ...
                    <Link className="flex justify-center" href="https://pictaphoto.com/walgreens"><button className="bg-[#db3753] w-40 lg:w-[10rem] h-12 lg:h-[3.8rem] rounded-[15px] text-white mt-5 hover:bg-[#fcfcfc] border-red-600 border-2 border-solid hover:text-[#db3753] transition duration-300">Notre site web</button></Link>
                </section>
                <section className="bg-[#171717] px-5 lg:px-0 pt-8 lg:pt-16 w-full pb-16  flex justify-center">
                    <div className="flex flex-col max-w-[75rem]">
                        <h2 className="text-[1.6rem] lg:text-[3.5rem] lg:pr-3 lg:pr-0 lg:pl-6 flex flex-col pb-12 lg:pb-20 text-white ">
                            Recherche & Développement
                            <span className="absolute lg:pt-12 pl-6 pt-5 text-red-600 text-[2.2rem] lg:text-[4.2rem] italic font-extrabold ">nos explorations</span>
                        </h2>
                        <div className="lg:grid lg:grid-cols-2 pt-16 lg:pt-40 gap-10">
                            <div>
                            ...
                            <div>
                                <h2 className="text-white text-3xl text-end pt-16 lg:pt-36 pb-10">Parce qu'on ne cesse d'innover !</h2>
                                <Image src={wb} alt="wb" />

...
export default function Footer(props: any) {
    if (props.theme === "white") {
        return(
            <footer className="bg-[#fcfcfc] flex py-9 w-full px-8 justify-center">
                <div className="flex justify-between w-[75rem] text-black">
                    ...
                    <div className="grid grid-cols-3 gap-2 leading-5">
                        ...
                        <div className="col-start-1 col-end-3 flex flex-row"> <Image className="w-7 h-6" src={langue} width={73} height={63} alt="langues" /><p>Passer à la version anglaise</p></div>
                    </div>
                </div>
            </footer>
        )
    ...
    if (props.theme === "black") {
        return (
            <footer className="bg-[#171717] flex py-9 w-full px-8 justify-center">
                <div className="flex justify-between w-[75rem] text-white">
                    <div className="w-[218px]">
                        <Link href="/"><Image width={800} height={160} alt="logo" src={logo} /></Link>
                        <p className="pt-3">BAT B - 3ème étage</p>
                        <p>46 rue Marco Polo</p>
